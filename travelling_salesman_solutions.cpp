...
int main(){
	...
	// std::cout<<CheddarOptimalSolution.isOptimal<<std::endl;
	// std::vector<std::string> testPath = CheddarOptimalSolution.findPath("tesco");
	// for(auto const& pathIterator: testPath){
	// 	std::cout<<pathIterator<<std::endl;
	// }
